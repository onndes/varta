...
(стандартна група, відпустки, заблоковані дні, несумісні пари, мала група, борги/карма), генератор
...
| 7   | Effective Load         | Зважений баланс           | `Load + debt` (при увімкненому `considerLoad`)                                         |
