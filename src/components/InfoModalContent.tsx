...
export const InfoModalContent: React.FC = () => (
  <div style={{ maxHeight: '70vh', overflowY: 'auto', fontSize: '0.9rem', lineHeight: 1.6 }}>
    <p className="text-muted mb-3">
      <strong>ВАРТА</strong> — система автоматичного та справедливого розподілу добових чергувань у
      невеликому колективі (2–100 осіб). Працює повністю офлайн (PWA), дані зберігаються локально в
      IndexedDB (Dexie.js).
    </p>
    ...
    <ul className="mb-3">
      <li>
        <strong>Пріоритет закриття днів</strong> — якщо є хоча б один доступний — система призначає
        чергового. Пропуск зміни неприпустимий.
      </li>
      <li>
    ...
    <ul className="mb-3">
      ...
      <li>
        <strong>Заблоковані дні тижня</strong> — для кожної особи можна заблокувати конкретні дні
        тижня з періодом дії та коментарем причини.
      </li>
      <li>
    ...
    <ul className="mb-3">
      <li>
        <strong>Нарахування боргу</strong> — борг з'являється лише при знятті «за проханням». Розмір
        залежить від ваги дня.
      </li>
      <li>
      ...
      <li>
        <strong>Погашення боргу</strong> — зменшується при призначенні з підвищеним пріоритетом.
      </li>
      <li>
        <strong>Максимальний борг</strong> — обмежений настроюваним значенням (за замовчуванням
        4.0).
      </li>
      <li>
    ...
    <p className="mb-3">
      Підтримка кількох баз даних (робочих просторів). Кожна база — окремий колектив з незалежним
      розкладом, складом та налаштуваннями. Швидке перемикання через меню у заголовку.
    </p>
