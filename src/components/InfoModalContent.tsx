...
const ScheduleSection: React.FC = () => (
  <>
    ...
    <ul className="mb-3">
      ...
      <li>
        <strong>Перевірка перед генерацією</strong> — перед запуском система показує зведення по
        періоду: хто має статус (відпустка, відрядження, лікування, відсутність), хто виключений з
        авторозподілу, у кого заблоковані дні тижня, та попереджає, якщо доступних людей на тиждень
        менше за потрібну кількість нарядів. Можна продовжити генерацію або скасувати й спершу
        виправити статуси. Вимикається у Налаштуваннях («Підтвердження перед генерацією»).
      </li>
      <li>
        <strong>Виправити конфлікти</strong> — автоматично замінює недоступних чергових. Для ручних
        винятків можна обрати <strong>«Залишити так»</strong>.
      </li>
      <li>
    ...
    <ul className="mb-3">
      <li>
        ...
        <ul className="mt-1">
          ...
          <li>
            <em>Зняти</em> — знімає особу з наряду.
          </li>
        </ul>
      </li>
      <li>
...
const StatsSection: React.FC = () => (
  <>
    ...
    <p className="mb-3">
      Зведена таблиця по кожній особі: кількість чергувань, навантаження, індекс справедливості,
...
const SettingsSection: React.FC = () => (
  <>
    ...
    <ul className="mb-3">
      ...
      <li>
        <strong>Режим ротації</strong> — можна залишити класичні поодинокі наряди або ввімкнути
        блочну ротацію: N діб поспіль у наряді, потім M діб відсипного.
      </li>
      <li>
      ...
      <li>
        <strong>Підтвердження перед генерацією</strong> — показувати зведення (статуси, виключені з
        авторозподілу, заблоковані дні тижня, нестача людей) перед «Генерація» / «Заповнити».
    ...
    <h6 className="fw-bold mt-3 mb-2">
      <i className="fas fa-calendar-check me-2 text-warning"></i>Пріоритет після тижня без чергувань
    </h6>
    <p className="mb-2">
      Якщо боєць пропустив тиждень — алгоритм м&apos;яко підвищує його пріоритет на наступний
      тиждень. Ефект зростає квадратично з кількістю пропущених тижнів і плавно зменшується для груп
      більше 7 осіб (повністю вимикається при ≥14).
    </p>

    <h6 className="fw-bold mt-3 mb-2">
      <i className="fas fa-hand-paper me-2 text-warning"></i>Force-наряд у заблокований день
    </h6>
    <p className="mb-2">
      Налаштування «Алгоритм автозаповнення → Force-наряд у заблокований/недоступний день» визначає,
      як такий наряд враховується у справедливості: <strong>як звичайний наряд</strong>,{' '}
      <strong>нейтрально</strong> (не впливає на розподіл — після зняття статусів генерація
      будується чесно, ніби force-наряду не було). Жорсткі правила (відпочинок, несумісні пари,
      тижневі ліміти) діють завжди.
    </p>
